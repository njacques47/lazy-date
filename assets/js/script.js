...
var errorHandlerEl = document.querySelector("#event-api-error")
var hideEventEl = document.querySelector("#event-panel");
...
function displayEventList (json) {
  ...
  // Hides the placeholder information when API renders a recipe
    ...
    hideEventEl.classList.add("hide");
    errorHandlerEl.classList.add("hide");
